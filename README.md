...
## OUTPUT:
<img width="927" height="274" alt="image" src="https://github.com/user-attachments/assets/c3f40782-beac-47d4-9a9a-ea4bcae484cf" />


## RESULT:
The host took 0.861994 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 11.255889 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
